...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/piyash12345/past/blob/main/a.txt"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/ummmah.sona.pakhi.id.link.nao")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://m.me/ummmah.sona.pakhi.id.link.nao")
	subprocess.check_output(["am", "start", "https://m.me/ummmah.sona.pakhi.id.link.nao"])
